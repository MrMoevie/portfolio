...
namespace UnityEditor
{
	...
	public class PrefabBrush : GridBrushBase
	{
		...
		public int m_Z;
        public Vector3Int lastposition = new Vector3Int(0, 0, 0);
		public override void Paint(GridLayout grid, GameObject brushTarget, Vector3Int position)
		{
            brushTarget = GameObject.FindWithTag("tilemap");
            if(position == lastposition) {Debug.Log("hey you there!");return;}
			...
			if (instance != null)
			{
                ...
                //Selection.activeGameObject= GameObject.Find("Grid/Tilemap");
			}
		}
